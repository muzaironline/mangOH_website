...
rh.consts('DEFAULT_TOPIC', encodeURI("#41113251_mangOH_Red_GSG_-_HTML5/41113251_Tut_Quick_Start/41113251_Tut_Quick_Start.htm".substring(1)));
rh.consts('HOME_FILEPATH', encodeURI("index.html"));
rh.consts('START_FILEPATH', encodeURI('index.html'));
rh.consts('HELP_ID', '1DAF837A-64D7-4A4C-815A-5EB56F5B9FF7' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "mangOH Red HL78xx Getting Started Guide (Windows) [Rev1]");
