...
rh.consts('DEFAULT_TOPIC', encodeURI("#41113347_mangOH_Yellow_GSG_-_HTML5/Get_Started/Get_Started.htm".substring(1)));
rh.consts('HOME_FILEPATH', encodeURI("index.html"));
rh.consts('START_FILEPATH', encodeURI('index.html'));
rh.consts('HELP_ID', '518520D5-AEAD-4852-A7B7-368A3F63E7D8' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "mangOH Yellow Getting Started Guide [Rev4]");
