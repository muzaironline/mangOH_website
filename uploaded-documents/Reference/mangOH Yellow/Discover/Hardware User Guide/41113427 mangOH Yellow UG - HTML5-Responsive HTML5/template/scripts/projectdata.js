...
rh.consts('DEFAULT_TOPIC', encodeURI("#41113427_mangOH_Yellow_UG_-_HTML5/Introduction/Introduction.htm".substring(1)));
rh.consts('HOME_FILEPATH', encodeURI("index.html"));
rh.consts('START_FILEPATH', encodeURI('index.html'));
rh.consts('HELP_ID', '011A6C9E-13A7-41F5-8F03-2ADE435F12C6' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "mangOH Yellow User Guide [Rev2]");
